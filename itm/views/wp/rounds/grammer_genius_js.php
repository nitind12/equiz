<?php if ($qa_pkg['res_'] == TRUE) { ?>
    ...
    <?php } ?>
        ...
        function p() {
            $('#start_button').hide();
            showAll();
            $('#grammer_genius_annimation').css('opacity','.5');
            $('#nextBut_').click();
            clearTimer();
        }
        function hideAll(){
        ...
        $('#start_').click(function () {
            ...
            if (nextCounter > totalCount - 1) {
                ...
                //$('#think_').show();
                //$('#think_').transition({scale: 1.5, delay: 50});
                //$('#think_').transition({scale: 1, delay: 100});
        ...
        $(targetElement).css({left: '-1px'});
        $(targetElement).animate(
                {
                    'left': $(document).width() - 1410,
                },
        {
            duration: speed,
            complete: function () {
    ...
    animateMe($('#grammer_genius_annimation'), 1000);
    </script>
<?php } ?>
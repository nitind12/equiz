<script>
    ...
    $('#start_').click(function () {
        ...
        if (nextCounter > totalCount) {
            ...
            $('#corrAnsBut_').delay(400).fadeIn(1000);
            $('#corrAnsBut_').delay(400).fadeIn(1200);
    ...
    $('#A_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/A.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#B_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/B.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#C_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/C.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#D_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/D.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#E_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/E.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#F_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/F.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#G_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/G.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#H_').click(function () {
        ...
        //$('#theme__').show();
        $('#chocobowl__').show();
        $('#chocobowl__').html('<img src="<?php echo base_url('nitnav/img/H.png') ?>" />');
        $('#theme__').click();
    });
    ...
    $('#PickYourChoice').children().not('#no').mouseenter(function () {
        ...
        $(this).children().css("background", "url('<?php echo base_url('nitnav/img/alphabetChoco_.jpg'); ?>')");
    });

    $('#PickYourChoice').children().not('#no').mouseleave(function () {
        $(this).transition({perspective: '0px', rotateY: '0deg'});
        $(this).children().css("background", "url('<?php echo base_url('nitnav/img/alphabetChoco.jpg'); ?>')");
    });

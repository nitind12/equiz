...
<style>
    ...
    #ques__{width:130px;float:left; padding-top:20px;}
    #everything{display:none;}
</style>
<body  background="<?PHP echo base_url() . 'nitnav/img/round6.jpg'; ?>"  style="margin-top:0px;" onload="p();">
    <div class="container" style="width: 100%;">
        <div class="row">
            <div class="col-sm-2">
                <!--<div id="topBox" align="center" style="border:0px;padding-top: 20px;">
                    <span style="color:#900;font-family:cooper black;font-size:55px;text-shadow:2px 2px 5px #ff0;" id="teamName_"></span>
                </div>-->
            </div>
            <div class="col-sm-5">
        ...
        <div id="everything">        
            <div class="row" style="margin-top:110px;">
                <div class="col-sm-12" style="background:#900; height:auto;" id="qBack">
                    ...
                    <div id="question" style="background:#900;border:0px; padding-left:130px;font-size:50px; line-height: 50px;"></div>
                </div>
            </div>

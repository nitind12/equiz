<?php if ($qa_pkg['res_'] == TRUE) { ?>
    ...
    <body  background="<?PHP echo base_url() . 'nitnav/img/round4.jpg'; ?>"  style="margin-top:0px;" onload="p();">
        <div class="container" style="width: 100%;">
            ...
            <div class="row">
                ...
                <div class="col-sm-2" align="right">
                    <div id="timer" style="float:right; color:#000080; text-shadow:2px 2px 10px #f0f0f0;">
            ...
            <div class="row" align="center">
                <div class="col-sm-12" id="NEXTT" style="margin-top:350px;position:absolute;left:-1000px;border-radius:10px;display:none;font-size:60px; color:#000080;border:2px #fff dashed; background:#ffff00; line-height: 80px;">
            ...
            <div class="row" style="position:fixed; top:300px; width:100%;left:550px;">
                <div class="col-sm-2">
                    <div class="col-sm-1">
                        <a class="voverlay" id="videoplayer" href="#" title="amrapali1"><img src="<?PHP echo base_url() . 'nitnav/img/video_icon.png'; ?>" alt="amrapali1" /></a>
                    </div>
                    <button class="btn btn-link col-sm-2" id="showQues_" style="float:right;margin-top:30px;">Q</button>
                </div>
            </div>
